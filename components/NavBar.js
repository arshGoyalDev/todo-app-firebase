...
const NavBar = () => {
  ...
  return (
    <header className="z-50 sticky w-[90vw] left-[5vw] top-[5vw] md:w-[80vw] md:left-[10vw] md:top-10 flex justify-between items-center py-4 px-4 lg:px-10 bg-gray-50 dark:bg-zinc-900 border-2 border-gray-200 dark:border-zinc-800 rounded-xl">
