const GoogleAuthButton = () => {
  return (
    <button className="flex justify-center gap-3 items-center w-full max-w-[460px] py-3 border-2 border-gray-300 dark:border-zinc-800 rounded-xl hover:bg-gray-400 hover:text-black dark:hover:text-white hover:border-transparent hover:dark:bg-zinc-800 hover:bg-opacity-10 transition-all duration-300">
